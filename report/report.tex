...
Another halting condition is the tolerance condition.
...
Another example is a lower bound for parameters that usually decrease in the optimization procedure, such as the trust region in COBYLA.

In general, a tolerance condition is defined as a floating point number.
Different optimizers give different meaning to the tolerance value.
I chose 4 different values to experiment with: $2 \times \e{-1}$, $\e{-2}$, $\e{-5}$, and $\e{-12}$. They are used in different settings.
