...
\begin{table}[]
    ...
    \begin{tabular}{|c|c|c|}
    \hline
    $n$ & COBYLA & Powell \\ \hline
    4 & \begin{tabular}[c]{@{}c@{}}25/25 reached 0.4\\ 25/25 reached 0.1\\ avg nfev 470.8\end{tabular} & \begin{tabular}[c]{@{}c@{}}25/25 reached 0.4\\ 25/25 reached 0.1\\ avg nfev 2297.64\end{tabular} \\ \hline
    5 & \begin{tabular}[c]{@{}c@{}}25/25 reached 0.4\\ 24/25 reached 0.1\\ avg nfev 994.88\end{tabular} & \begin{tabular}[c]{@{}c@{}}25/25 reached 0.4\\ 25/25 reached 0.1\\ avg nfev 4190.72\end{tabular} \\ \hline
    6 & \begin{tabular}[c]{@{}c@{}}25/25 reached 0.4\\ 0/25 reached 0.1\\ avg nfev 6984.6\end{tabular} & \begin{tabular}[c]{@{}c@{}}25/25 reached 0.4\\ 22/25 reached 0.1\\ avg nfev 24049.04\end{tabular} \\ \hline
    7 & \begin{tabular}[c]{@{}c@{}}25/25 reached 0.4\\ 10/25 reached 0.1\\ avg nfev 14062.4\end{tabular} & \begin{tabular}[c]{@{}c@{}}23/24 reached 0.4\\ 22/24 reached 0.1\\ avg nfev 15815.37\end{tabular} \\ \hline
    \end{tabular}
    \caption{The number of successful experiments and average Number of Function EVals (nfev) for different optimizers and numbers of qubits. For technical reasons, the Powell experiments with 7 qubits could not be completed.}
    \label{tbl:optimizer_results}
\end{table}
...
% The success rates of each number of qubits are given in table \mytodo{Add a table!}.
% \begin{table}[]
%     \begin{tabular}{|c|c|}
%     \hline
%     $n$ & success rate ($C=0.4$) \\ \hline
%     4 & 5/5 \\ \hline
%     5 & 5/5 \\ \hline
%     6 & 5/5 \\ \hline
%     7 & 5/5 \\ \hline
...
% Tal Mor and I considered a different idea, which uses the cost function value at \emph{multiple, different locations} as part of this optimization. Using this kind of optimizer, we could use the following method:
% \begin{enumerate}
%     \item 	Start with a parametrized circuit (which spans the entire space), and a \emph{random} initial guess of parameters $\thetas_0$.
%     \item Run the circuit and get an initial cost evaluation (based on$\thetas_0$).
